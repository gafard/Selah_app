/// 🔄 ADAPTATEUR POUR CONVERTIR LES PRESETS EXISTANTS
/// 
...
class PresetTheologyAdapter {
  
  /// 🔄 Convertit un PlanPreset existant vers le format TheologyGate
  ...
  static List<String> _generateTags(Original.PlanPreset original) {
    ...
    if (name.contains('psaumes') || name.contains('psalm')) {
      tags.addAll(['psalms', 'worship', 'prayer', 'psaume-119']);
    }
  ...
  /// 📋 Extrait les préférences du profil utilisateur
